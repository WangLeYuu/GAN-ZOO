...
parser.add_argument("--dataset_name", type=str, default="easy2flexible",
                    help="name of the datasets")  ## ../input/facades-datasets
...
dataloader = DataLoader(  ## 改成自己存放文件的目录
    ImageDataset("datasets/easy2flexible", transforms_=transforms_, unaligned=True),
...
val_dataloader = DataLoader(
    ImageDataset("datasets/easy2flexible", transforms_=transforms_, unaligned=True, mode="test"),  ## "./datasets/facades"
    batch_size=5,
    shuffle=True,
    num_workers=0,
)
