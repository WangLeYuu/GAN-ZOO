"""
StarGAN (CelebA)
The datasets can be downloaded from: https://www.dropbox.com/sh/8oqt9vytwxb3s4r/AADIKlz8PR9zr6Y20qbkunrba/Img/img_align_celeba.zip?dl=0
...
1. Download the datasets and annotations from the provided link
2. Copy 'list_attr_celeba.txt' to folder '11'
2. Save the folder '11' to '../../data/'
...
parser.add_argument("--dataset_name", type=str, default="11", help="name of the datasets")
...
parser.add_argument(
    ...
    "--list",
    nargs="+",
    help="selected attributes for the CelebA datasets",
